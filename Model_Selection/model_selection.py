...
class RankModels(object):
    ...
    def __init__(
            ...
            downsampling: int = 10,
            min_length: int = 256,
            root_dir: str = r'D:/Master/SS_2024_Thesis_ISA/Thesis/Work-docs/RAMS-TSAD/Mononito/trained_models/Anomaly_Archive/006_UCR_Anomaly_DISTORTEDCIMIS44AirTemperature2/',
            normalize: bool = True,
            verbose: bool = False):
